...
public class Ticket {
    ...
    public static void main(String[] args) {
        ...
        switch (select) {
            ...
            case 'D':
                ...
                break;
            default:
                System.out.println("Böle bir şehir yok");
                break;
    ...
    private static void tekMiCiftMi(double kmPrice, int age) {
        ...
        if (secim == 2) {
            if (age >= 0 && age < 12) {
                System.out.println("Bilet Tutarınız :" + (kmPrice * 0.5) * 0.8);
            } else if (age >= 12 && age < 24) {
                System.out.println("Bilet Tutarınız :" + (kmPrice * 0.9) * 0.8);
            } else if (age >= 24 && age <= 65) {
                System.out.println("Bilet Tutarınız :" + (kmPrice * 1) * 0.8);
            } else if (age > 65) {
                System.out.println("Bilet Tutarınız :" + (kmPrice * 0.7) * 0.8);
            } else {
                System.out.println("Yaşınız 0'dan küçük olamaz.");
            }
